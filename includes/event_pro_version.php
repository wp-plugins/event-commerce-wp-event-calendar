...
<div class="wrapper">
  <div class="wrap" style="float:left; width:100%;">
    ...
    <div style="width:70%;float:left;"><h2>EventCommerce WP Responsive Event Calendar Pro</h2></div>
       <div class="main_div">
        <div class="metabox-holder" style="width:98%; float:left;">
            <div id="namediv" class="stuffbox" style="width:60%;min-height:450px;">
              ...
              <div style="padding-top:15px;margin-left:20px;">
                <a class="btnprover" target="_blank" href="http://codecanyon.net/item/eventcommerce-wp-responsive-event-calendar-pro/10716644?ref=wpproducts" style="width:100px;height: 20px;background-color: green;color:white;" >EventCommerce WP Responsive Event Calendar Pro</a>
              </div>  
