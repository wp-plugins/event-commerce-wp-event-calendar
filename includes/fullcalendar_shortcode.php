<?php  
  function evntgen_sccalendar_shortcode($atts){ 
...
where scd.id=".$schedule;* /
  ...
  $booked_bg_color = evntgen_scevent_get_opt_val('_booked_bg_color',EVNTGEN_BOOKED_BG_COLOR);
    ...
    include_once GENSCEVENT_DIR.'operations/get_cssfixfront.php';
	...
	add_shortcode('evntgen_sccalendar','evntgen_sccalendar_shortcode');