<?php
function evntgen_scevent_install() {
	global $table_prefix, $wpdb;
  $table_name1 = $table_prefix.'evntgen_scevents';
  $sql_sfe = "CREATE TABLE IF NOT EXISTS ".$table_name1." (
   ...
   $wpdb->query($sql_sfe);
	 //-------------------------------
	 $table_name2 = $table_prefix.'evntgen_scevents_paymentmethods';
   ...
   $wpdb->query($sql_scpm);
	 ...
	 $pm_count = $wpdb->get_results("SELECT COUNT(*) as pm_rowcount FROM ".$table_prefix."evntgen_scevents_paymentmethods");
   if(!$pm_count[0]->pm_rowcount){
      $sql_pm_data = "INSERT INTO `".$table_prefix."evntgen_scevents_paymentmethods` (`id`,`payment_method`) VALUES (2,'Bank'),(3,'Cash'),(4,'Paypal'),(5,'Credit Card'),(6,'Other');";
  ...
  if(!$curr_count[0]->rowcount){
    ...
    $wpdb->query($currency_tbl_data);
	 ...
	 //===============================End Currency Table==============================
	 $scevent_calendar_page_id = evntgen_programmatically_create_page('SC Event Calendar','sc-event-calendar','[evntgen_sccalendar]','page');
