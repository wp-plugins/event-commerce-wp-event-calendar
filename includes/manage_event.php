<?php
		...
		jQuery(document).ready(function(){
              ...
              jQuery("#inner_content").html(data);
				...
				function evntgen_loading_show(){
						jQuery('#loading').html("<img src='<?php echo GENSCEVENT_PLUGIN_URL; ?>/images/loading.gif'/>").fadeIn('fast');
				}
  ...
  <style type="text/css">
		#btnsearchevent{
			background:url('<?php echo GENSCEVENT_PLUGIN_URL ?>/images/search.png') no-repeat;
			width: 30px; 
			height: 30px; 
			cursor:pointer;
		}
  ...
  <div class="wrap" style="float:left; width:100%;">
    ...
    <div style="width:29%;float:left;margin-top:15px;">
      ...
      <!--<img src="<?php// echo GENSCEVENT_PLUGIN_URL ?>/images/search.png" height="20px" width="20px" />-->
    </div>
